...
const CreateExam = () => {
  ...
  const [allTestBanks, setAllTestBanks] = useState([]);
  ...
  useEffect(() => {
    const loadTestBanks = async () => {
      ...
      if (data) {
        setAllTestBanks(data); // store all test banks
      } else {
  ...
  const filterTestBanksByCourse = () => {
    const filtered = allTestBanks.filter(
      (bank) =>
        bank.course_code &&
        bank.course_code.toLowerCase() === courseCode.toLowerCase()
    );
                ...
                <CardContent>
                  ...
                  <Grid container spacing={3} sx={{ mt: 1 }}>
                    <Grid item xs={12} md={4}>
                      <Typography>
                        Multiple Choice (Available: {file.mc})
                      </Typography>
                      <TextField
                        type="number"
                        fullWidth
                    ...
                    <Grid item xs={12} md={4}>
                      <Typography>
                        Identification (Available: {file.id})
                      </Typography>
                      <TextField
                        type="number"
                        fullWidth
          ...
          <Box sx={{ mt: 4 }}>
            ...
            >
              <CardContent>
                ...
                <Typography>
                  Identification Questions: {questionCounts.identification}
                </Typography>
